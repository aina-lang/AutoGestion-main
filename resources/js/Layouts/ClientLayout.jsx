...
export default function ClientLayout({ header, children }) {
    ...
    return (
        <div className="flex h-screen bg-neutral-50 transition-colors duration-300 dark:bg-gray-900">
            <Sidebar auth={auth}>
                <SidebarItem
                    ...
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex min-h-full items-center space-x-2">
                                {/* <SecondaryButton isSticky className="border border-gray-300 bg-white dark:border-gray-600 dark:bg-gray-700 dark:text-white">
