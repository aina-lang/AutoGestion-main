...
export default function AllCars({ auth, latestVehicles, categories, search }) {
    ...
    const [query, setQuery] = useState({
        search: search.search || '', // Préreplir avec la valeur de 'search' ou une chaîne vide si elle est absente
        date_depart: search?.date_depart || '', // Si 'date_depart' est défini dans 'search', on l'utilise
        date_retour: search?.date_retour || '', // Idem pour 'date_retour'
    ...
    return (
        <GuestLayout auth={auth} footerShown={false}>
            <Head title="Vezo Tours - Découvrez votre expérience de voyage" />
            ...
            <div className="flex h-screen justify-start overflow-hidden bg-gray-50 text-gray-800">
                <section className="left-0 right-0 top-0 z-30 mx-auto min-h-screen w-64 pb-5">
                    <div className="mx-5 mt-24 w-full rounded-md bg-white px-6 py-5 text-gray-800 shadow-lg">
                ...
                >
                    <div>
                        <div className="my-14 rounded-lg p-6">
                            ...
                            {cars.length <= 0 ? (
                                ...
                                cars.map((car, index) => (
                                    ...
                                    >
                                        ...
                                        >
                                            {/* Image on the left */}
                                            <div className="relative mr-4 h-48 w-48 flex-shrink-0 overflow-hidden rounded-l-md">
                                                <img
                                                    src={
                                                        '/storage/' +
                                                        JSON.parse(
